...
/**
 * ViewTransactionsPanel - Admin panel to view all purchases.
 */
public class ViewTransactionsPanel extends JPanel {
    ...
    private void initComponents() {
        ...
        JLabel titleLabel = new JLabel("System Transactions");
        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 28));
        titleLabel.setForeground(Color.WHITE);

        JLabel subTitleLabel = new JLabel("View a complete history of all land sales and purchases.");
        ...
        // Table
        String[] columns = {"ID", "Land Title", "Buyer", "Seller", "Amount (LKR)", "Status", "Date"};
        ...
        try {
            ...
            for (Transaction t : transactions) {
                tableModel.addRow(new Object[]{
                    ...
                    t.getStatus(),
                    t.getTransactionDate() != null ? t.getTransactionDate().substring(0, 10) : ""
                });
            }
        } catch (Exception e) {
